"""Logging utilities for PyCronGuard.
...
def setup_logging(
    ...
    """Configure the root logger for PyCronGuard.
    ...
    * Applies ``JsonFormatter`` when *json_format* is ``True``;
    ...
    log_file = os.path.join(log_dir, "pycronguard.log")
...
def get_logger(name: str) -> logging.Logger:
    ...
    Parameters:
        name: Dot-separated logger name (e.g. ``pycronguard.core``).
