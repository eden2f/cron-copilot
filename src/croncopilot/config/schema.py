...
This module defines the complete configuration structure for CronCopilot,
...
class StorageConfig:
    ...
    db_path: str = "~/.croncopilot/data.db"
...
class ScriptConfig:
    ...
    script_dir: str = "~/.croncopilot/scripts"
    version_dir: str = "~/.croncopilot/script_versions"
    max_versions: int = 10
...
class AppConfig:
    ...
    pid_file: str = "~/.croncopilot/croncopilot.pid"
