"""Multi-channel alert system for CronCopilot.
...
from croncopilot.storage.models import AlertLog, TaskExecution
    ...
    def check_and_alert(self, task_id: str, execution: TaskExecution) -> None:
        ...
        for strategy in self._strategies:
            try:
                ...
                subject = f"[CronCopilot Alert] {alert_type} — Task {task_id}"
