"""Execution status tracker for CronCopilot tasks.

Integrates with :class:`~croncopilot.core.executor.TaskExecutor` callback
...
class ExecutionTracker:
    ...
    def bind_executor(self, executor: "TaskExecutor") -> None:  # noqa: F821
        ...
        """
        from croncopilot.core.executor import TaskExecutor  # local import to avoid circular
